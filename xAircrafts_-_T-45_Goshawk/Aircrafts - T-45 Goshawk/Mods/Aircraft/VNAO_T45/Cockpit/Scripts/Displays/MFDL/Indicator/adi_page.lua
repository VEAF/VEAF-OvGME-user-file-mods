...
ADIBase.element_params 	 = {"MFDL_ONOFF","MFDL_PAGE"} 
...
adiLadder.element_params  = {"CURRENT_ROLL","CURRENT_PITCH","PITCH_TRIM","MFDL_BRIGHTNESS"}  
...
waterline.element_params  = {"MFDL_ONOFF","MFDL_PAGE"} 
...
GSorigin.element_params  = {"ILS_GS","MFDL_ONOFF","MFDL_PAGE"} 
...
LOCorigin.element_params = {"ILS_LOC","MFDL_ONOFF","MFDL_PAGE"} 
...
rollPointerOrigin.element_params  	= {"CURRENT_ROLL","MFDL_ONOFF","MFDL_PAGE"} 		
...
headingBase.element_params  = {"MFDL_ONOFF","MFDL_PAGE"}  
