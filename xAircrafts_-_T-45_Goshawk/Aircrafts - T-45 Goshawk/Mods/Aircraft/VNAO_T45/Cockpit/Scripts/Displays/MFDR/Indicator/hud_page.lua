...
-------------- Left Side ------------------------------------------------
addText("IAS", IASPos, {"CURRENT_IAS","MFDR_BRIGHTNESS"}, {{"text_using_parameter",0,0},{"opacity_using_parameter",1}}, {"%.0f"} , origin.name, "CenterTop", HUD_sdef_regularLarge, HUD_font)
local IASbox = addBox("IASBox",horizontalPos(14), verticalPos(6),"IAS",0.0007,{"MFDR_BRIGHTNESS"},{{"opacity_using_parameter",0}}, {0}, HUD_material, true)
IASbox.init_pos={0,verticalPos(-3.5)}

addText("GroundSpeed", GSPos, {"CURRENT_GS","MFDR_BRIGHTNESS","approach","DECLUTTER_LEVEL"}, {{"parameter_in_range",3,0},{"parameter_in_range",2,0},{"text_using_parameter",0,0},{"opacity_using_parameter",1}}, {"GS %.0f"}, origin.name, "LeftCenter", HUD_sdef_regular, HUD_font)
addText("AOA", AOAPos, {"CURRENT_AOA","MFDR_BRIGHTNESS","DECLUTTER_LEVEL"}, {{"parameter_in_range",2,0},{"text_using_parameter",0,0,1},{"opacity_using_parameter",1}}, {"@ %.1f"} , origin.name, "LeftCenter", HUD_sdef_regular, HUD_font)
addText("mach", MachPos, {"CURRENT_MACH","MFDR_BRIGHTNESS","approach","DECLUTTER_LEVEL"}, {{"parameter_in_range",3,0},{"parameter_in_range",2,0},{"text_using_parameter",0,0},{"opacity_using_parameter",1}} , {"M %.2f","%s"} , origin.name, "LeftCenter", HUD_sdef_regular, HUD_font)
addText("G", GPos, {"CURRENT_G","MFDR_BRIGHTNESS","approach","DECLUTTER_LEVEL"}, {{"parameter_in_range",3,0},{"parameter_in_range",2,0},{"text_using_parameter",0,0},{"opacity_using_parameter",1}} , {"G %.1f"} , origin.name, "LeftCenter", HUD_sdef_regular, HUD_font)
addText("peakG", peakGPos, {"MAX_G","MFDR_BRIGHTNESS","approach","DECLUTTER_LEVEL"}, {{"parameter_in_range",0,3.99,15},{"parameter_in_range",3,0},{"parameter_in_range",2,0},{"text_using_parameter",0,0},{"opacity_using_parameter",1}} , {"  %.1f"} , origin.name, "LeftCenter",HUD_sdef_regular, HUD_font)

addText("time", timePos, {"timeHour","timeMins","timeSec","MFDR_BRIGHTNESS","approach","DECLUTTER_LEVEL"}, {{"parameter_in_range",5,0},{"parameter_in_range",4,0},{"text_using_parameter",0,0},{"text_using_parameter",1,0},{"text_using_parameter",2,1},{"opacity_using_parameter",3}}, {"%02.0f:","%02.0f"}, origin.name,nil,HUD_sdef_regular,HUD_font)
--------------- Right Side ---------------------------------------
addText("verticalVelocity", VVPos, {"CURRENT_VV","MFDR_BRIGHTNESS"}, {{"text_using_parameter",0,0},{"opacity_using_parameter",1}} , nil, origin.name,nil,HUD_sdef_regular,HUD_font)

addText("altitude1000", ALTPos, {"ALT_1000s","MFDR_BRIGHTNESS"}, {{"text_using_parameter",0,0},{"opacity_using_parameter",1}}, nil , origin.name, "RightTop", HUD_sdef_regularLarge,HUD_font)
addText("altitude100", {horizontalPos(60),verticalPos(34)}, {"ALT_100s","MFDR_BRIGHTNESS"}, {{"text_using_parameter",0,0},{"opacity_using_parameter",1}} , {"%03.0f"}, origin.name, "LeftTop",HUD_sdef_regular,HUD_font)
local altBox = addBox("altBox",horizontalPos(17), verticalPos(6),"altitude1000",0.0007,{"MFDR_BRIGHTNESS"},{{"opacity_using_parameter",0}},{0}, HUD_material, true)
altBox.init_pos={horizontalPos(2),verticalPos(-3.5)}

addText("RadarAlt", RALTPos, {"CURRENT_RALT","MFDR_BRIGHTNESS"}, {{"parameter_in_range",0,1,5000},{"text_using_parameter",0,0},{"opacity_using_parameter",1}}, {"%.0f R"}, origin.name,nil,HUD_sdef_regular,HUD_font)

addText("tacanRange", {horizontalPos(70),verticalPos(-22)}, {"TACAN_RANGE","MFDR_BRIGHTNESS","TACAN_SELECTED"}, {{"parameter_in_range",0,-1,999},{"parameter_in_range",2,1},{"text_using_parameter",0,0},{"opacity_using_parameter",1}}, {"%.1F TCN"}, origin.name,nil,HUD_sdef_regular,HUD_font)
addText("waypointRange", {horizontalPos(70),verticalPos(-22)}, {"SELECTED_WAYPOINT_RANGE","MFDR_BRIGHTNESS","WAYPOINT_SELECTED","ACTIVE_WAYPOINT"}, {{"parameter_in_range",0,-1,999},{"parameter_in_range",2,1},{"text_using_parameter",0,0},{"text_using_parameter",3,1},{"opacity_using_parameter",1}}, {"%.1F W","%02.0f"}, origin.name,nil,HUD_sdef_regular,HUD_font)
------------------------------------------------------------------
------------------- Velocity Vector -------------------------------------
...
VelVecCircle.element_params  = {"MFDR_BRIGHTNESS"}
...
VVLU.element_params  = {"MFDR_BRIGHTNESS"}
...
VVLL.element_params  = {"MFDR_BRIGHTNESS"}
...
VVLR.element_params  = {"MFDR_BRIGHTNESS"}
...
AoaE.element_params  = {"E_POS","approach","MFDR_BRIGHTNESS"}
...
local function add_ladder_line(name, width, half_gap, tick, shift_y, pitch, controllers)
	...
	for i = 0, 1 do
		...
		line1.element_params  = {"MFDR_BRIGHTNESS"}
		...
		line2.element_params  = {"MFDR_BRIGHTNESS"}
		...
		if shift_y ~= 0 then
			...
			local text = addSimpleText(name.."_numerics_"..side_name,  pitchLimited, HUD_sdef_regularLarge, textAlign, {(half_gap + width + sizePercent(2)) * side, DegToMet(pitchLimited)}, lineOrigin.name, nil, nil, HUD_font, {"MFDR_BRIGHTNESS"})
...
local function add_roll_line(name, width, roll)
	for i = 0, 1 do
		...
		line1.element_params  = {"MFDR_BRIGHTNESS","DECLUTTER_LEVEL","MASTER_MODE"}
...
tri.element_params  = {"MFDR_BRIGHTNESS"}
...
headingBase.level			= DEFAULT_LEVEL -2
headingBase.isvisible		= false
headingBase.collimated      = false
headingBase.element_params  = {"MFDR_ONOFF","DECLUTTER_LEVEL","MFDR_PAGE"}  
...
for i = counterBegin, counterEnd do
	...
	dot.element_params  = {"MFDR_BRIGHTNESS"}
	...
	if heading % 2 == 0 then -- only print text for every 10 degrees
		local text = addSimpleText(heading.."_number", heading/10, HUD_sdef_regular, "CenterBottom", {0,verticalPos(5)}, dot.name, nil, nil, HUD_font, {"MFDR_BRIGHTNESS"})
		text.h_clip_relation = h_clip_relations.INCREASE_IF_LEVEL
		text.level			 = DEFAULT_LEVEL -2
		text.controllers     = {{"opacity_using_parameter",0}}	
	end
end
...
HDGCaret.element_params  = {"MFDR_BRIGHTNESS","DECLUTTER_LEVEL"}
...
TCNcommandHeading.element_params = {"MFDR_BRIGHTNESS","TCN_CMDHDG","TACAN_SELECTED"}
...
WYPTcommandHeading.element_params = {"MFDR_BRIGHTNESS","WYPT_CMDHDG","WAYPOINT_SELECTED"}
...
scratch_output.element_params  = {"SCRATCH_PAD","SCRATCH_ON","MFDR_BRIGHTNESS"}
...
addBox("scratchpad",horizontalPos(35),verticalPos(6),scratch_output.name,0.0007,{"MFDR_BRIGHTNESS"},{{"opacity_using_parameter",0}},{0}, HUD_material)
...
DSLaimingCircleSmall.element_params  = {"MFDR_BRIGHTNESS"}
