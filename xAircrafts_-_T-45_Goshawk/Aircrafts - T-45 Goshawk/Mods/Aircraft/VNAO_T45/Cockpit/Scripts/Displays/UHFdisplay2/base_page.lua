...
--local center = {0,-0.47,-0.55}  --- {L/R,U/D,forward/back}
...
base.init_pos		 = {0.35,-0.617,-0.772}  --- {L/R,U/D,forward/back}   
base.init_rot		 = {5.8,0,91}
...
base.element_params  = {"GEN_BUS","COMM2_ON"}  
...
frequency.element_params  = {"COMM2_FREQUENCY","COMM2_BRIGHTNESS"}
