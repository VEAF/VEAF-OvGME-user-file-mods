...
-- compass_elem.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_HEADING"}
...
box_elem.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_HEADING"}
...
n_indic.value = "N"
n_indic.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_HEADING", Nav_Radar_Display}
n_indic.controllers = {
...
s_indic.value = "S"
s_indic.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_HEADING", Nav_Radar_Display}
s_indic.controllers = {
	{"opacity_using_parameter", 0},
	{"rotate_using_parameter", 1, -1.0},
	{"parameter_in_range",2,0.95,1.05}
...
local function make_ticks(material, opaque)
	...
	local parameters = {"NAV_RADAR_HEADING", Nav_Radar_Display, Nav_Radar_brightness_parameter}
...
box_drift.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_HEADING", "DRIFT_MARKER"}
...
gs_indic.element_params = {Nav_Radar_brightness_parameter, "HudGS"}
...
waypoint_lab.element_params = {Nav_Radar_brightness_parameter, "CURRENT_WAYPOINT"}
...
heading_txt.element_params = {Nav_Radar_brightness_parameter, "NAV_RADAR_DEGREE"}
...
arrow_number_hyp.element_params = {Nav_Radar_brightness_parameter, "WIND_NUMBER_POSHYP", "WIND_END_Y", "Wind_knts", "Wind_knts"}
